                                        ...
                                        <div class="blog_post_page portfolio_post blog_post_content">
                                            ...
                                            <section class="blog_post-topline">
                                                ...
                                                <div class="blog_post-meta">
                                                    <?php
                                                    $published_text = '<span class="attachment-meta">' . esc_html__('Published on', 'pizzahit') . '<time class="entry-date" datetime="%1$s">%2$s</time>' . esc_html__('in', 'pizzahit') . '<a href="%3$s" rel="gallery">%5$s</a></span>';
                                                    ...
                                                    printf('<span class="attachment-meta full-size-link"><a href="%1$s" title="%2$s">%3$s (%4$s &times; %5$s)</a></span>',
                                                        ...
                                                        esc_attr__('Link to full-size image', 'pizzahit'),
                                                        esc_html__('Full resolution', 'pizzahit'),
                                                        $metadata['width'],
                                                        $metadata['height']
                                                    );

                                                    edit_post_link(esc_html__('Edit', 'pizzahit'), '<span class="edit-link">', '</span>');
                                                    ?>
                                                </div>
                                            </section>
                                            <?php if (!empty($post->post_content)) { ?>
                                                <article class="contentarea">
                                                    <?php the_content(); ?>
                                                    <?php wp_link_pages(array('before' => '<div class="page-links">' . esc_html__('Pages:', 'pizzahit'), 'after' => '</div>')); ?>
                                                </article>
                                            <?php } ?>
                                            ...
                                            <div class="prev_next_links">
                                                <span class="gallery_back">
                                                    <a href="<?php echo esc_js("javascript:history.back()");?>"></a>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
