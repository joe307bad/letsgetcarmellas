...
function get_theme_fonts()
{
    ...
    if (in_array(gt3_get_theme_option("additional_font"), $list_of_fonts)) {
        $allFonts[] = gt3_get_theme_option("additional_font") . gt3_get_theme_option("google_font_parameters_additional_font");
    }
