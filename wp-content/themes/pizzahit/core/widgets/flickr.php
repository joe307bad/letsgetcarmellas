...
class flickr extends WP_Widget {
	...
	?>
		<table class="fullwidth">
			...
			<tr>
				<td>Flickr ID:</td>
				<td><input type='text' class="fullwidth" name='<?php echo $this->get_field_name( 'flickr_widget_id' ); ?>' value='<?php echo esc_attr($instance['flickr_widget_id']); ?>'/></td>
			</tr>
			<tr>
				<td>Number:</td>
				<td><input type='text' class="fullwidth" name='<?php echo $this->get_field_name( 'flickr_widget_number' ); ?>' value='<?php echo esc_attr($instance['flickr_widget_number']); ?>'/></td>
			</tr>
		</table>
	<?php
	}
