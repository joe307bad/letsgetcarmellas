...
function single_tab($atts, $content = null) {
	extract( shortcode_atts( array(
		...
		return "<h6 class='shortcode_tab_item_title expand_".$expanded_state."'>".$title."</h6><div class='shortcode_tab_item_body tab-content clearfix'><div class='ip'>".$content."</div></div>";
