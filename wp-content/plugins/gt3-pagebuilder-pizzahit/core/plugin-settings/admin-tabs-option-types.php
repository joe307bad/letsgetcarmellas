...
class ColorOption extends Option
{
	protected function render_control()
	{
		...
		return '<div class="color_option_admin"><span class="sharp">#</span><input class="medium cpicker textoption type1" maxlength="25" type="text" name="'.$this->params['id'].'" id="'.$this->params['id'].'" '.(!empty($this->value)?'value="'.htmlspecialchars($this->value).'"':'').' /></div>';
	}
}
