...
jQuery(document).ready(function () {
  ...
  jQuery(document).on('click', '.add_new_port_skills', function () {
    ...
    jQuery(this).parents(".port_skills_cont").find(".all_added_skills").append("<li class='stand_iconsweet ui-state-default new_added' style='display:none'> <input type='text' class='itt_type1' name='pagebuilder[page_settings][portfolio][skills]["+skill_rand+"][name]' placeholder='Field name' value=''> <input type='text' class='itt_type1' name='pagebuilder[page_settings][portfolio][skills]["+skill_rand+"][value]' placeholder='Field Link' value=''> <span class='remove_skill'><i class='stand_icon icon-times'></i></span></li>");
		jQuery('.new_added').slideDown(300).removeClass('.new_added');
  });

  jQuery(document).on('click', '.add_new_model_params', function () {
    var skill_rand = getRandomInt(0, 99999);
    jQuery(this).parents(".port_skills_cont").find(".all_added_skills").append("<li class='stand_iconsweet ui-state-default new_added' style='display:none'> <input type='text' class='itt_type1' name='pagebuilder[page_settings][model][params]["+skill_rand+"][name]' placeholder='Field name' value=''> <input type='text' class='itt_type1' name='pagebuilder[page_settings][model][params]["+skill_rand+"][value]' placeholder='Field value' value=''> <span class='remove_skill'><i class='stand_icon icon-times'></i></span></li>");
		jQuery('.new_added').slideDown(300).removeClass('.new_added');
  });
  jQuery(document).on('click', '.add_new_model_skills', function () {
    var skill_rand = getRandomInt(0, 99999);
    jQuery(this).parents(".port_skills_cont").find(".all_added_skills").append("<li class='stand_iconsweet ui-state-default new_added' style='display:none'> <input type='text' class='itt_type1' name='pagebuilder[page_settings][model][skills]["+skill_rand+"][name]' placeholder='Field name' value=''> <input type='text' class='itt_type1' name='pagebuilder[page_settings][model][skills]["+skill_rand+"][value]' placeholder='Field value in percent' value=''> <span class='remove_skill'><i class='stand_icon icon-times'></i></span></li>");
		jQuery('.new_added').slideDown(300).removeClass('.new_added');
  });
  ...
  function show_settings_popup(thisTrigger, popupContainerClass) {
    ...
    if (jQuery('.edit_popup.nowOpen').find('.select_img_preview').find('img').attr('src') == '')
        jQuery('.edit_popup.nowOpen').find('.select_img_preview').find('img').css('display', 'none');
  }
  ...
  jQuery(document).on('click', '.add_new_accordion_section', function () {
    ...
    /* add new class accordion */
    jQuery(document).on('click', '.add_new_class_section', function () {
      var target1 = jQuery(this).parents(".edit_popup").find(".sections");
      var this_key1 = jQuery(this).parents(".module-cont").find(".module_key").val();
      var tinyrand = "tiny"+getRandomInt(0, 9999);
      var data = {
      ...
      jQuery.post(ajaxurl, data, function (response) {
        if (already_added_elemts_count>0) {
          var this_append = "<li class='section'><div class='heading line_option visual_style1 big_type'><div class='option_title text-shadow1'>Section</div><div class='some-element clickable edit hovered'></div><div class='pre_toggler'></div><div class='some-element movable move hovered'></div><div class='pre_toggler'></div><div class='some-element clickable delete hovered'></div><div class='pre_toggler'></div></div><div class='clear'></div><div class='hide_area'><div class='some-padding'><input type='text' class='expanded_text1 type1 section_name' name='pagebuilder[modules][module_id][module_items][section_id][title]' value='Section'><textarea class='expanded_text1 type2 mt tinytextarea' id='ajax"+response+"' name='pagebuilder[modules][module_id][module_items][section_id][description]'></textarea></div></div></li>";
        } else {
          var this_append = "<li class='section'><div class='heading line_option visual_style1 big_type'><div class='option_title text-shadow1'>Section</div><div class='some-element clickable edit hovered'></div><div class='pre_toggler'></div><div class='some-element movable move hovered'></div><div class='pre_toggler'></div><div class='some-element clickable delete hovered'></div><div class='pre_toggler'></div></div><div class='clear'></div><div class='hide_area'><div class='some-padding'><input type='text' class='expanded_text1 type1 section_name' name='pagebuilder[modules][module_id][module_items][section_id][title]' value='Section'><textarea class='expanded_text1 type2 mt tinytextarea' id='ajax"+response+"' name='pagebuilder[modules][module_id][module_items][section_id][description]'></textarea></div></div></li>";
        }
  ...
  /* add new timetable block */
  jQuery(document).on('click', '.add_new_timetable_block', function () {
    var target3 = jQuery(this).parents(".rows_must_be_here").find(".row-list");
    var this_key3 = jQuery(this).parents(".rows_must_be_here").find(".moduleid").val();
    var data = {
      action:'get_unused_id_ajax'
    ...
    jQuery.post(ajaxurl, data, function (response) {
      ...
      var this_append = "<li class='section'><div class='heading line_option visual_style1 big_type'><div class='option_title text-shadow1'>&nbsp;</div><div class='some-element clickable edit hovered'></div><div class='pre_toggler'></div><div class='some-element movable move hovered'></div><div class='pre_toggler'></div><div class='some-element clickable delete hovered'></div><div class='pre_toggler'></div></div><div class='clear'></div><div class='hide_area'><div class='some-padding'><div class='caption'>Time interval</div><input class='expanded_text type3' name='pagebuilder[modules][module_id][module_items][section_id][time_interval]'>      <div class='caption'>Monday</div><input class='expanded_text type3' name='pagebuilder[modules][module_id][module_items][section_id][monday_timetable]'>      <div class='caption'>Tuesday</div><input class='expanded_text type3' name='pagebuilder[modules][module_id][module_items][section_id][tuesday_timetable]'>      <div class='caption'>Wednesday</div><input class='expanded_text type3' name='pagebuilder[modules][module_id][module_items][section_id][wednesday_timetable]'>      <div class='caption'>Thursday</div><input class='expanded_text type3' name='pagebuilder[modules][module_id][module_items][section_id][thursday_timetable]'>      <div class='caption'>Friday</div><input class='expanded_text type3' name='pagebuilder[modules][module_id][module_items][section_id][friday_timetable]'>      <div class='caption'>Saturday</div><input class='expanded_text type3' name='pagebuilder[modules][module_id][module_items][section_id][saturday_timetable]'>      <div class='caption'>Sunday</div><input class='expanded_text type3' name='pagebuilder[modules][module_id][module_items][section_id][sunday_timetable]'><div class='clear'></div></div></div></li>";
  ...
  jQuery(document).on('keyup', '.some-padding .section_name:first-child', function () {
  ...
  jQuery(document).on('click', '.available-images-for-pf .ajax_cont .img-item', function(){
    ...
    jQuery.post(ajaxurl, data, function (response) {
      jQuery(".selected-images-for-pf").append("<div class='img-item append_animation style_small'><div class='img-preview'><img src='"+previewurl+"' data-full-url='"+pffullurl+"' data-thumb-url='"+previewurl+"' alt='' class='previmg'><div class='hover-container'></div><div class='deldel-container'></div></div><input type='hidden' name='pagebuilder[post-formats][images]["+response+"][attach_id]' value='"+pfattach_id+"'></div>");
  ...
  jQuery(document).on("click", ".all_available_font_icons .stand_icon", function () {
    ...
    jQuery(this).parents(".enter_option_row").find(".stand_social.active").removeClass("active");
  ...
  jQuery(document).on("click", ".social_list_for_select i", function () {
    ...
    jQuery(this).parents(".hright").find(".added_icons").append("<div class='stand_iconsweet new_added ui-state-default' style='display:none'><span class='stand_icon-container'><i class='stand_icon "+clicked_icon+"'></i></span><input type='hidden' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][data-icon-code]' value='"+clicked_icon+"'><input type='text' class='icon_name' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][name]' value='' placeholder='Give some name'><input type='text' class='icon_link' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][link]' value='' placeholder='Give some link'><input class='cpicker' type='text' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][fcolor]' value='#979797' placeholder='Foreground color'><div class='caption' style='width: 190px;'><h2>Open in New Window:</h2></div><div class='radio_selector'><div class='radio_toggle_cont on_off_style'><input type='radio' name='pagebuilder[page_settings][icons][icon-music5320][target]' value='on' checked='checked' class='checkbox_slide yes_state'><input type='radio' name='pagebuilder[page_settings][icons][icon-music5320][target]' value='off' class='checkbox_slide no_state'><div class='radio_toggle_mirage checked' style='background-position: 0% 0%;'></div></div></div><span class='remove_me'><i class='stand_icon icon-times'></i></span></div>");
		jQuery('.new_added').slideDown(300).removeClass('new_added');
    reactivate_color_picker();
    reactivate_sortable();
  });

  jQuery(document).on("click", ".social_list_for_select_team i", function () {
    var clicked_icon = jQuery(this).attr("data-icon-code");
    var rnd_team = getRandomInt(1000, 9999);
    jQuery(this).parents(".hright").find(".added_icons").append("<div class='stand_iconsweet new_added ui-state-default' style='display:none'><span class='stand_icon-container'><i class='stand_icon "+clicked_icon+"'></i></span><input type='hidden' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][data-icon-code]' value='"+clicked_icon+"'><input type='text' class='icon_name' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][name]' value='' placeholder='Give some name'><input type='text' class='icon_link' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][link]' value='' placeholder='Give some link'><input class='cpicker' type='text' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][fcolor]' value='#161616' placeholder='Foreground color'><div class='caption' style='width: 190px;'><h2>Open in New Window:</h2></div><div class='radio_selector'><div class='radio_toggle_cont on_off_style'><input type='radio' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][target]' value='on' checked='checked' class='checkbox_slide yes_state'><input type='radio' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][target]' value='off' class='checkbox_slide no_state'><div class='radio_toggle_mirage checked' style='background-position: 0% 0%;'></div></div></div><span class='remove_me'><i class='stand_icon icon-times'></i></span></div>");
		jQuery('.new_added').slideDown(300).removeClass('new_added');
    reactivate_color_picker();
    reactivate_sortable();
  });
  ...
  jQuery(document).on("click", ".social_list_for_select3 i", function () {
    var clicked_icon = jQuery(this).attr("data-icon-code");
    var rnd_team = getRandomInt(1000, 9999);
    jQuery(this).parents(".hright").find(".added_icons").append("<div class='stand_iconsweet new_added ui-state-default' style='display:none'><span class='stand_icon-container'><i class='stand_icon "+clicked_icon+"'></i></span><input type='hidden' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][data-icon-code]' value='"+clicked_icon+"'><input type='text' class='icon_name' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][name]' value='' placeholder='Field Name'><input type='text' class='icon_link' name='pagebuilder[page_settings][icons]["+clicked_icon+rnd_team+"][link]' value='' placeholder='Field Value'><span class='remove_me'><i class='stand_icon icon-times'></i></span></div>");
		jQuery('.new_added').slideDown(300).removeClass('new_added');
    reactivate_color_picker();
    reactivate_sortable();
  });
  ...
  jQuery(document).on("click", ".all_available_font_icons_for_any_icons i.stand_icon", function () {
	...
	jQuery('.contact_list_toggler').each(function(){
		if (jQuery(this).find('.radio_toggle_mirage').hasClass('not_checked')) {
			jQuery(this).parents('.padding-cont').addClass('hide_bg_inputs');
		} else {
			jQuery(this).parents('.padding-cont').removeClass('hide_bg_inputs');
		}	
	});

	jQuery('.contact_list_toggler').find('.radio_toggle_mirage').on('click', function(){
...
jQuery(document).ready(function () {
  ...
  if (jQuery('.img_upload_preview').size() > 0) {
    jQuery('.img_upload_preview').each(function(){
      var img_upload_src = jQuery(this).find('img').attr('src');
      if (!img_upload_src == '') {
...
// Select Image (media_attach_id) Image Box
jQuery(document).on("click", ".gt3_add_media_attach", function (event) {
  var gt3_add_media_attach_this = jQuery(this);
  ...
  gt3_file_frame.on('select', function () {
    ...
    gt3_add_media_attach_this.prev().val(gt3_image_attachment.id);

    gt3_add_media_attach_this.parents('.enter_option_row').find('.attach_id_added').find("img").remove();
    var data = {
      action: 'gt3_generate_60x60_media',
      url: gt3_image_attachment.url,
    }

    jQuery('.img_upload_preview').css({'display': 'inline-block'});

    jQuery.post(ajaxurl, data, function (response) {
      gt3_add_media_attach_this.parents('.enter_option_row').find('.attach_id_added').html("<img src='"+response+"' alt=''>");
    });

    // gt3_add_media_attach_this.parents('.enter_option_row').find('.attach_id_added').html("<img src='"+gt3_image_attachment.url+"' alt=''>");
    gt3_add_media_attach_this.parents('.enter_option_row').find('.gt3_image_selected_id').attr('value', gt3_image_attachment.url);
...
jQuery(document).on("click", ".attach_id_added ~.deldel-container", function (event) {
  jQuery(this).siblings(".attach_id_added").find("img").attr("src", "");
  jQuery(this).parents('.enter_option_row').find('.gt3_image_selected_id').val("");
  jQuery('.img_upload_preview').hide();
});

function gt3_checkSlider() {
  if (jQuery('.newselect[name*="preview_thumbs_format"] option[value="slider"]:selected ').length) {
    jQuery('.newselect[name*="preview_thumbs_format"] option[value="slider"]:selected ')
      .closest('.padding-cont').find('.newselect[name*="images_in_a_row"]').closest('.enter_option_row').hide()
      .siblings('.mb20.isotope_load').hide();
  }  
}

jQuery(document).on("change", '.newselect[name*="preview_thumbs_format"]', function (event) {
  if (jQuery(this).val() == 'slider') {
    ...
    jQuery(this)
      .closest('.padding-cont').find('.newselect[name*="images_in_a_row"]').closest('.enter_option_row').show()
      .siblings('.mb20.isotope_load').show();
    }
});
...
jQuery(document).ready(function () {
  jQuery('.save_pb_template').on('click', function(){
    jQuery('.form_save_template').slideToggle();
  });

  jQuery('.load_pb_template').on('click', function(){
    jQuery('.form_load_template').slideToggle();
  });

  jQuery('.delete_pb_template').on('click', function(){
    jQuery('.form_delete_template').slideToggle();
  });

  jQuery('input[name="save_template_submit"]').on('click', function(e){
    e.preventDefault();
    var form = jQuery('form#post'),
        template_name = jQuery('input[name="saved_template_name"]').val(),
        ok = true,
        exists_templates = jQuery('input[name="saved_template_name"]').attr('data-templates'),
        duplicate_name = true;

        if (exists_templates.length) {
          exists_templates = jQuery('input[name="saved_template_name"]').attr('data-templates').split(',');
          duplicate_name = exists_templates.every(function(val){
    ...
    if (!duplicate_name && exists_templates.length) {
      var agree = confirm('Template name already exists. Overwrite?');
      if (!agree) ok = false;
    }

    if (ok) {
      jQuery.post(ajaxurl, {
        action: 'gt3_save_template',
        serialize_string: JSON.stringify(form.serializeArray()),
        name: template_name
      }, function (response) {
        gt3_show_admin_pop('<b>DONE! You\'ve successfully saved the template.</b>', 'info_message');
        setTimeout(function() {
  ...
  jQuery('input[name="load_template_submit"]').on('click', function(e){
    e.preventDefault();
    var form = jQuery('form#post'),
        id = jQuery('#post_ID').val(),
        template_name = jQuery('select[name="load_template_name"]').val();

    if (template_name == undefined) {
      alert('There is no template to load.');
      return;
    }

    var agree = confirm('All existing modules will be removed. Are you sure?');
    if (agree) {
      jQuery.post(ajaxurl, {
        action: 'gt3_load_template',
        post_id: id,
        name: template_name
      }, function (response) {
        window.location.reload(true);
  ...
  jQuery('input[name="delete_template_submit"]').on('click', function(e){
    e.preventDefault();
    template_name = jQuery('select[name="delete_template_name"]').val();
    ...
    if (agree) {
      jQuery.post(ajaxurl, {
        action: 'gt3_delete_template',
        name: template_name
      }, function (response) {
        gt3_show_admin_pop('<b>DONE! You\'ve successfully deleted the template.</b>', 'info_message');
        setTimeout(function() {
          window.location.reload(true);
        }, 3000);
      });
  ...
  jQuery(document).on('click', '.ultimate_module_copy', function(){
    var builder_string = [],
        key = jQuery(this).closest('.module-cont').find('.module_key').val();

    jQuery.post(ajaxurl, {
      action: 'gt3_copy_block_to_clipboard',
      serialize_string: JSON.stringify(jQuery('form#post').serializeArray()),
      key: key
    }, function (response) {
      gt3_show_admin_pop('<b>DONE! You\'ve successfully copied block to the clipboard.</b>', 'info_message');
    });
  });

  jQuery('.paste_from_clipboard').on('click', function(){
    waiting_state_start();
    var tinyrand = "tiny"+getRandomInt(0, 9999),
    id = jQuery('#post_ID').val();

    jQuery.post(ajaxurl, {
      action: 'gt3_paste_block_from_clipboard',
      post_id: id,
      tinymce_activation_class:tinyrand
    }, function (response) {
      jQuery('.pb-list-active-modules .sortable-modules').append(response).tinymce_textareas("."+tinyrand);
  ...
  jQuery(document).on('click', '.ultimate_module_duplicate', function(){
    waiting_state_start();
    var key = jQuery(this).closest('.module-cont').find('.module_key').val(),
        tinyrand = "tiny"+getRandomInt(0, 9999),
        id = jQuery('#post_ID').val();

    jQuery.post(ajaxurl, {
      action: 'gt3_duplicate_block',
      serialize_string: JSON.stringify(jQuery('form#post').serializeArray()),
      post_id: id,
      tinymce_activation_class:tinyrand,
      key: key
  ...
  jQuery(document).on('click', '.copy-duplicate', function(e){
    if (jQuery(this).siblings('.copy-duplicate-wrap').css('opacity') == '0') {
      jQuery('.copy-duplicate-wrap').animate({'opacity': '0'}, 50).css('z-index', '');
      jQuery(this).siblings('.copy-duplicate-wrap').animate({'opacity': '1'}, 300).css('z-index', '1000'); 
      e.stopPropagation();
    }
  });
